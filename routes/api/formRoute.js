  ...
  try {
    ...
    async function main() {
      ...
      let transporter = nodemailer.createTransport({
        ...
        auth: {
          user: "offres@agent-comparateur.fr", // generated ethereal user
          pass: "KompaR@@0402@@$$", // generated ethereal password
        },
      });
      ...
      let info = await transporter.sendMail({
        from: "Kompar <offres@agent-comparateur.fr>", // sender address
        ...
        <h5>Cliquer ici <a href="https://agent-kompar.herokuapp.com:${process.env.PORT}/offer/${offer._id}">Offre de souscription</a> </h5>
